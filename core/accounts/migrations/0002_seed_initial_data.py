# Generated by Django 5.2.5 on 2025-08-20 18:28
...
def seed_initial_data(apps, schema_editor):
    ...
    # 3) Farm assigned to Agent (Bangladesh-based)
    ...
    # 5) Two cows owned by the Farmer
    ...
    # 6) Activities (vaccination/health) and MilkRecords
...
def unseed_initial_data(apps, schema_editor):
    ...
    # Delete created objects by unique identifiers
